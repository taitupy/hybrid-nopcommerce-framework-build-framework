...
public class Level_08_Page_Navigation extends BaseTest {
    ...
    private TimePageObject timePage;
    ...
    public void User_03_Switch_Page() {
        // Admin Page -> PIM Page
        pimPage = adminPage.openPimPage();
        // Add new Pim Page
        //...

        // Pim Page -> Time Page
        timePage = pimPage.openTimePage();
        // Add new Time Page
        //...

        // Time page -> Admin page
        adminPage = timePage.openAdminPage();
        // Add new Admin Page
        //...

        // Admin page -> Time page
        timePage = adminPage.openTimePage();
        // Add new Time Page
        //...
        pimPage = timePage.openPimPage();
        adminPage = pimPage.openAdminPage();
